...
{
    [Fact]
    public async Task RejectReturnOrderItem_WhenRequestValid_ReturnsSuccess()
    {
        ...
        var rejectReturnOrderItemRequest = new Dictionary<Guid, string>()
        {
            { returnOrderItem.Id, "testReason" }
        };
        var request = new RejectReturnOrderItemRequest(returnOrder.Id, rejectReturnOrderItemRequest);
        var result = await orderService.RejectReturnOrderItemAsync(request);
        Assert.True(result.IsSuccess);
        Assert.Equal(ReturnStatus.Rejected, returnOrderItem.Status);
    }

    [Fact]
    public async Task RejectReturnOrderItem_WhenTokenInvalid_ReturnsTokenInvalid()
    {
        var connection = new SqliteConnection("DataSource=:memory:");
        connection.Open();
        var options = new DbContextOptionsBuilder<ApiDbContext>().UseSqlite(connection).Options;
    ...
    [Fact]
    public async Task RejectReturnOrderItem_WhenUserNotFound_ReturnsUserNotFound()
    {
        var connection = new SqliteConnection("DataSource=:memory:");
        connection.Open();
        var options = new DbContextOptionsBuilder<ApiDbContext>().UseSqlite(connection).Options;
    ...
    [Fact]
    public async Task RejectReturnOrderItem_WhenNotPermitted_ReturnsNotPermitted()
    {
        var connection = new SqliteConnection("DataSource=:memory:");
        connection.Open();
        var options = new DbContextOptionsBuilder<ApiDbContext>().UseSqlite(connection).Options;
    ...
    [Fact]
    public async Task RejectReturnOrderItem_WhenShopNotFound_ReturnsShopNotFound()
    {
        var connection = new SqliteConnection("DataSource=:memory:");
        connection.Open();
        var options = new DbContextOptionsBuilder<ApiDbContext>().UseSqlite(connection).Options;
        ...
        var rejectReturnOrderItemRequest = new Dictionary<Guid, string>()
        {
            { Guid.NewGuid(), "testReason" }
        };
        var request = new RejectReturnOrderItemRequest(Guid.NewGuid(), rejectReturnOrderItemRequest);
        var result = await orderService.RejectReturnOrderItemAsync(request);
        Assert.False(result.IsSuccess);
        Assert.Equal(ErrorType.NotFound, result.ErrorType);
    }
    ...
    [Fact]
    public async Task RejectReturnOrderItem_WhenInvalidState_ReturnsInvalidState()
    {
        var connection = new SqliteConnection("DataSource=:memory:");
        connection.Open();
        var options = new DbContextOptionsBuilder<ApiDbContext>().UseSqlite(connection).Options;
    ...
    [Fact]
    public async Task RejectReturnOrderItem_WhenReturnOrderNotFound_ReturnsReturnOrderNotFound()
    {
        var connection = new SqliteConnection("DataSource=:memory:");
        connection.Open();
        var options = new DbContextOptionsBuilder<ApiDbContext>().UseSqlite(connection).Options;
    ...
    [Fact]
    public async Task RejectReturnOrderItem_WhenReturnOrderItemNotFound_ReturnsReturnOrderItemNotFound()
    {
        var connection = new SqliteConnection("DataSource=:memory:");
        connection.Open();
        var options = new DbContextOptionsBuilder<ApiDbContext>().UseSqlite(connection).Options;
    ...
    [Fact]
    public async Task RejectReturnOrderItem_WhenConcurrencyConflict_ReturnsConcurrencyConflict()
    {
        var connection = new SqliteConnection("DataSource=:memory:");
        connection.Open();
        var options = new DbContextOptionsBuilder<ApiDbContext>().UseSqlite(connection).Options;
    ...
    [Fact]
    public async Task RejectReturnOrderItem_WhenDatabaseError_ReturnsDatabaseError()
    {
        var connection = new SqliteConnection("DataSource=:memory:");
        connection.Open();
        var options = new DbContextOptionsBuilder<ApiDbContext>().UseSqlite(connection).Options;
