...
public record UpdateVoucherRequest(Guid VoucherId, Guid? ItemId, int? Quantity, decimal? Value, Method? Method, Target? Target, decimal? MaxDiscountAmount, DateTime? StartDate, DateTime? EndDate, decimal? MinSpend ,bool? IsActive);