...
{
    [Fact]
    public async Task CancelEntireOrder_WhenRequestValid_ReturnsSuccess()
    {
        ...
        {
            Id = Guid.NewGuid(),
            UserName = "123w2314567",
            PasswordHash = "1234w5116789",
            FullName = "Joh1n Doew",
            PhoneNumber = "088188w88888",
        ...
        var request = new CancelEntireOrderRequest(order.Id, "testReason");
    ...
    [Fact]
    public async Task CancelEntireOrder_WhenTokenInvalid_ReturnsTokenInvalid()
    {
        var connection = new SqliteConnection("DataSource=:memory:");
        connection.Open();
        var options = new DbContextOptionsBuilder<ApiDbContext>().UseSqlite(connection).Options;
    ...
    [Fact]
    public async Task CancelEntireOrder_WhenUserNotFound_ReturnsUserNotFound()
    {
        var connection = new SqliteConnection("DataSource=:memory:");
        connection.Open();
        var options = new DbContextOptionsBuilder<ApiDbContext>().UseSqlite(connection).Options;
    ...
    [Fact]
    public async Task CancelEntireOrder_WhenUserRoleInvalid_ReturnsUserRoleInvalid()
    {
        var connection = new SqliteConnection("DataSource=:memory:");
        connection.Open();
        var options = new DbContextOptionsBuilder<ApiDbContext>().UseSqlite(connection).Options;
    ...
    [Fact]
    public async Task CancelEntireOrder_WhenOrderNotFound_ReturnsOrderNotFound()
    {
        var connection = new SqliteConnection("DataSource=:memory:");
        connection.Open();
        var options = new DbContextOptionsBuilder<ApiDbContext>().UseSqlite(connection).Options;
        ...
        var orderService = new OrderService(
            ...
            mockUserManager.Object,
            mockTransactionService.Object);
        var request = new CancelEntireOrderRequest(Guid.NewGuid(),"testReason");
        var result = await orderService.CancelEntireOrderAsync(request);
        Assert.False(result.IsSuccess);
        Assert.Equal(ErrorType.NotFound, result.ErrorType);
    }
    ...
    [Fact]
    public async Task CancelEntireOrder_WhenOrderStatusInvalid_ReturnsOrderStatusInvalid()
    {
        var connection = new SqliteConnection("DataSource=:memory:");
        connection.Open();
        var options = new DbContextOptionsBuilder<ApiDbContext>().UseSqlite(connection).Options;
    ...
    [Fact]
    public async Task CancelEntireOrder_WhenConcurrencyConflict_ReturnsConcurrencyConflict()
    {
        var connection = new SqliteConnection("DataSource=:memory:");
        connection.Open();
        var options = new DbContextOptionsBuilder<ApiDbContext>().UseSqlite(connection).Options;
    ...
    [Fact]
    public async Task CancelEntireOrder_WhenDatabaseError_ReturnsDatabaseError()
    {
        var connection = new SqliteConnection("DataSource=:memory:");
        connection.Open();
        var options = new DbContextOptionsBuilder<ApiDbContext>().UseSqlite(connection).Options;
